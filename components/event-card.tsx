...
export function EventCard({ 
  ...
  return (
    <div className="relative w-full min-w-[1000px] max-w-6xl flex bg-gradient-to-r from-black/40 to-black/20 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden group transform transition-all duration-500 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]">
      {/* Slots Available Counter */}
      <div className="absolute top-4 right-4 z-50 flex flex-col gap-2">
        {stagGlCount && stagGlCount > 0 && (
      ...
      <div className="flex flex-col justify-between p-8 flex-1">
        <div>
          ...
          {/* Title & Description */}
          <h3 className="text-2xl font-bold text-white mb-3">{eventName}</h3>
          <p className="text-[#9ca3af] mb-6 line-clamp-3">{eventDescription}</p>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/80">{venue.venueName}</span>
          </div>
        </div>
